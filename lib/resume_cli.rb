...
module ResumeCli
  module Commands
    ...
    class ResumePdf < Dry::CLI::Command
      desc "Spits resume pdf string"
      ...
      def call(markdown_src:, html_doc_template_src:, title:, **)
        puts Formats.pdf(markdown_src, html_doc_template_src, title)
      end
    end

    register "pdf", ResumePdf, aliases: ["pdf"]
  end
end
